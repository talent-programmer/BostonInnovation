...
function Index() {
  return (
    <>
      ...
      <div
        className="bg-local bg-cover relative"
        style={{
        ...
        <div className="relative z-10">
          ...
          >
              ...
              <div className="w-full overflow-hidden">
                ...
                >
                  {[org1, org2, org3, org4, org5, org6].map((src, index) => (
                    <div
                      key={index}
                      className="flex justify-center flex-1 p-2 align-middle"
                    >
            ...
            <div className="container mx-auto mt-20">
              <div
                className="flex flex-col justify-center mx-auto md:w-1/2"
                style={{
                  fontSize: "45px",
                  lineHeight: "60px",
                  color: "#FFFFFF",
              ...
              >
                <span>Colleges with involved</span>
                <span style={{ color: "#2596BE" }}>student researchers:</span>
                <span style={{ fontSize: "24px", lineHeight: "35px" }}>
                  This list consists of various schools that we have students
                  who contribute to research and innovation at our company!
                </span>
              </div>
            ...
            <div className="container mx-auto mt-20 text-center">
              ...
              >
                <span>
                  Please reach out to the link below or text our company line!
                  We would love to partner with others who are as passionate in
                  science as we are!
                </span>
              </div>
              <div
