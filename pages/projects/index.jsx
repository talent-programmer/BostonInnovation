        ...
        >
          ...
          <div className="container mx-auto mt-10">
            ...
            <ProjectItem
              ...
              description={
                "Using machine learning and artificial intelligence models, we are invested in creating a custom machine learning system to replace large-scale bureaucratic tasks at healthcare institutions."
              }
              description1={
            ...
            <ProjectItem2
              ...
              description={
                "In response to the dire shortage of medical supplies in Ukraine and other war-affected regions, Boston Innovations partnered with talented students from local hackathons to create an affordable and effective 3D-printed medical tourniquet."
              }
              description1={
                "We now aim to develop a next-generation tourniquet equipped with advanced technology. Imagine a tourniquet that not only automatically stops blood flow but also calls emergency medical services (EMS) at the same time. By integrating cutting-edge AI and IoT technologies, we aim to save even more lives in critical situations."
              }
            />
            <ProjectItem
              image={project3}
          ...
          <div className="container mx-auto mt-20">
            ...
            >
              <a href="mailto:outreach@bostoninnovations.org">
                ...
                >
                  <span
                    // href="mailto:outreach@bostoninnovations.org"
