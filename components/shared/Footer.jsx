    ...
    <footer className="py-12 text-white" style={{background: '#021723', fontFamily: 'Helvetica, Arial, sans-serif'}}>
      <div className="container px-6 mx-auto">
        <div className="flex flex-col justify-between lg:flex-row">
          <div className="flex flex-col w-full mb-6 lg:w-1/4 basis-[30%]"> {/* mainpart */}
            ...
            <div className="flex space-x-3">
              <a href="https://discord.gg/6Z73xt5fWJ" target='_blank' rel='noreferrer'><Image src={logodiscord} className="inline w-7" alt="Discord" /></a>
              <a href=""><Image src={logox} className="inline w-7" alt="Twitter" /></a>
              <a href="https://www.linkedin.com/company/boston-innovations/" target='_blank' rel='noreferrer'><Image src={logolink} className="inline w-7" alt="LinkedIn" /></a>
        ...
        <div className="pt-6 mt-6 text-center border-t border-gray-700">
          <a href='https://www.linkedin.com/company/boston-innovations/' target='_blank' rel='noreferrer'><p className="text-sm">&copy; 2024 Boston Innovations. All Rights Reserved.</p></a>
        </div>
      </div>
    </footer>
  );
